...
/*
    ...
    <div className="w-[250px] animate-slideright2  inline 0lg:hidden">
    <Image
        alt=''
        src={data.FoodImage}
        width={1920}
...
<div className="flex flex-col items-center 0lg:items-start justify-start p-[15px] 3lg:p-0 3lg:w-[70%] 0lg:w-[40%]  ml-[10px] mb-[30px]">
 <span className="text-[18px] font-bold text-orange-500 animate-slideleft  ">Today Our Spical Dish</span>     
 <span id='cursive' className="text-[25px] font-bold text-slate-800 animate-slideleft2 ">{data.name}</span>   

 <span id='cursive' className=" text-left text-gray-500 text-[15px] animate-slideleft3 ">
  {data.Foodinfo.slice(0, 150)}...
 </span> 
 <div className='w-full h-[60px] flexRowCenter items-center   justify-between' >
    <div className='w-[50%] h-auto flexColCenter items-start '>
 <span  className=" text-[15px]   font-bold text-[gold] animate-slideleft3 flexRowCenter">       
  <FaStar/>
  <FaStar/>
  <FaStar/> 
  <FaStar/> 
    ...
    <div className="flexRowCenter px-[14px] animate-slideleft4   py-[8px] bg-orange-500 rounded  text-slate-100 hover:scale-110 
    transition-all duration-75 ease-in cursor-pointer   ">
        Order Now <FaShoppingCart className='text-[23px]  ' /> 
    </div>
</div>
</div>
<div className="w-[230px] h-full animate-slideright2  hidden 0lg:inline mb-[30px]">
     <Image
        alt=''
        src={data.FoodImage}
        width={1920}
